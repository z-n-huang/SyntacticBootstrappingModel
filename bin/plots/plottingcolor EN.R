...
v3_mc <- read_csv(paste("results/verbreps_resultsmc 1-3.csv", sep = ""))
v4_mc <- read_csv(paste("results/verbreps_resultsmc 1-4.csv", sep = ""))
v5_mc <- read_csv(paste("results/verbreps_resultsmc 1-5.csv", sep = ""))
v6_mc <- read_csv(paste("results/verbreps_resultsmc 1-6.csv", sep = ""))
v7_mc <- read_csv(paste("results/verbreps_resultsmc 1-7.csv", sep = ""))
v8_mc <- read_csv(paste("results/verbreps_resultsmc 1-8.csv", sep = ""))
v9_mc <- read_csv(paste("results/verbreps_resultsmc 1-9.csv", sep = ""))
v0_mc <- read_csv(paste("results/verbreps_resultsmc 1-0.csv", sep = ""))
...
v0_mc$itr <- 2
verbreps_results <- rbind(
  read_csv(paste("results/verbreps_resultsmc 1-1.csv", sep = "")),
  v3_mc, v4_mc, v5_mc, v6_mc, v7_mc, v8_mc, v9_mc, v0_mc
)

p3_mc <- read_csv(paste("results/projection_resultsmc 1-3.csv", sep = ""))
p4_mc <- read_csv(paste("results/projection_resultsmc 1-4.csv", sep = ""))
p5_mc <- read_csv(paste("results/projection_resultsmc 1-5.csv", sep = ""))
p6_mc <- read_csv(paste("results/projection_resultsmc 1-6.csv", sep = ""))
p7_mc <- read_csv(paste("results/projection_resultsmc 1-7.csv", sep = ""))
p8_mc <- read_csv(paste("results/projection_resultsmc 1-8.csv", sep = ""))
p9_mc <- read_csv(paste("results/projection_resultsmc 1-9.csv", sep = ""))
p0_mc <- read_csv(paste("results/projection_resultsmc 1-0.csv", sep = ""))
...
p0_mc$itr <- 2
projection_results <- rbind(
  read_csv(paste("results/projection_resultsmc 1-1.csv", sep = "")),
  p3_mc, p4_mc, p5_mc, p6_mc, p7_mc, p8_mc, p9_mc, p0_mc
)
unique(projection_results$itr)

## Without penalty (original)
